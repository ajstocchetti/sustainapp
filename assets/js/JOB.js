/**	Credit where credit is due:
	This would not be possible without the JOB repository from EddieLa
...
JOB = {
	...
	DecoderWorker : new Worker("/assets/js/DecoderWorker.js"),	// UPDATE IF DIRECTORY CHANGES
	...
	Init : function() {
		...
		var script  = document.createElement('script');
  		script.src  = "/assets/js/exif.js";	// UPDATE IF DIRECTORY CHANGES
